...
public class CustomRepositoryFactoryBean<T extends JpaRepository<S, ID>, S, ID extends Serializable>
	...
	private static class CustomRepositoryFactory extends JpaRepositoryFactory {// 3 创建CustomerRepositoryFactory,并继承JpaRepositoryFactory
		...
		protected JpaRepositoryImplementation getTargetRepository(RepositoryInformation information, EntityManager entityManager) {// 4 重写getTargeRepository方法，获得当前自定义的Reposiotry实现
